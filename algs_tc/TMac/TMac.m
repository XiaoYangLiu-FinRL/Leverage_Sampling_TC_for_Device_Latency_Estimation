...
if isfield(opts,'alpha_adj')     alpha_adj = opts.alpha_adj;  else    alpha_adj = 1; end
...
sx = cell(1,N);
reschg = ones(1,N); 
reschg_tol = max(1e-2,10*tol);     %秩上升的上限
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function rank_dec_adaptive()                               %秩下降
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function rank_inc_adaptive()                                                                        %秩上升
